...
class Installer(object):
    ...
    def installer_login_message(self, message_type):
    ...
    def get_job_images(self, rec_type: str = None, rec_id: int = None):
